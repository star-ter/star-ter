  ...
  return (
    <div className="relative" style={{ width: size, height: size }}>
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center">
        <span className="text-h1 font-bold text-slate-800">{score}</span>
        <span className="text-caption text-slate-400">/ 99점</span>
      </div>
    </div>
  );
};
    ...
    <div className="bg-white rounded-xl border border-slate-200 overflow-hidden my-4">
      ...
      <div className="px-6 py-4 border-b border-slate-100">
        <div className="flex items-center justify-between">
          <div>
            <h3 className="text-body font-strong text-slate-800">생존 분석</h3>
            {areaName && <p className="text-sm text-slate-500">{areaName}</p>}
          </div>
          <span
            className="px-3 py-1 rounded-full text-caption font-medium text-white"
      ...
      <div className="grid grid-cols-3 divide-x divide-slate-100 border-b border-slate-100">
        ...
        <div className="p-5 text-center">
          <div className="flex items-center justify-center gap-2 mb-2">
            ...
            <span className="text-caption text-slate-500">폐업률</span>
          </div>
          <div className="text-h2 font-bold text-slate-800">{closingRate}%</div>
        ...
        <div className="p-5 text-center">
          <div className="flex items-center justify-center gap-2 mb-2">
            ...
            <span className="text-caption text-slate-500">평균 영업</span>
          </div>
          <div className="text-h2 font-bold text-slate-800">
            {avgOperationMonths}개월
          </div>
          <div className="text-caption text-slate-400 mt-1">
            {avgOperationMonths >= 60
              ? '안정적'
              : avgOperationMonths >= 36
                ? '보통'
                : '불안정'}
          </div>
        </div>
        ...
        <div className="p-5 text-center">
          <div className="flex items-center justify-center gap-2 mb-2">
            ...
            <span className="text-caption text-slate-500">상권 상태</span>
          </div>
          <div className="text-h2 font-bold text-slate-800">
            {changeStatus || '-'}
          </div>
          {dataSource && (
            <div className="text-caption text-slate-400 mt-1">{dataSource}</div>
          )}
        </div>
      </div>
      ...
      <div className="p-6">
        <div className="flex items-center gap-8">
          ...
          <div className="flex-1">
            <h4 className="text-h3 font-strong text-slate-800 mb-2">
              {interpretation}
            </h4>
            ...
            <div className="mt-4">
              ...
              <div className="flex justify-between text-caption text-slate-400 mt-1">
                <span>0</span>
                <span>99</span>
              </div>
            </div>
